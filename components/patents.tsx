...
export default function Patents() {
  const [patentsList, setPatentsList] = useState(patents)
  ...
  return (
    <section>
      <h2 className="text-2xl font-bold mb-6">专利发明</h2>

      <div ref={ref} className="space-y-4">
        {patentsList.map((patent, index) => (
          <Card
            key={index}
            className={cn(
              ...
              <div className="flex items-start">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm mb-3">
                    发明人:{" "}
                    {patent.inventors.split("，").map((inventor, i, arr) => (
                      <span key={i}>
