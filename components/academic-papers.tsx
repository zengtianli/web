...
// 默认论文数据
const defaultPapersData: PapersContent = {
  title: "学术论文",
  items: [
    {
    ...
    },
    {
      ...
      year: "2019",
      authors: "Zeng T., Wu W.",
      abstract: "This paper presents a novel depth-averaged two-dimensional model for simulating flow and sediment transport in open channels. The model incorporates physically-based parameters and has been validated using field measurements from various river systems.",
      link: ""
    }
  ]
};
