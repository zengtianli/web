// AUTO-GENERATED from ~/Dev/configs/menus/navbar.yaml (R7.1 HSBC mega)
...
export interface MegaGroup { title: string; items: MegaItem[]; dark?: boolean }
export interface MegaCategory {
  key: string
  label: string
  light_columns: MegaGroup[][]   // 长度恒为 3（可含空数组占位）
  dark_column: MegaGroup[]       // 可为空
}
