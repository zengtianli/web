// AUTO-GENERATED from ~/Dev/configs/menus/navbar.yaml (R7 mega)
...
export interface MegaSection { title: string; items: MegaItem[] }
export interface MegaCategory { key: string; label: string; sections: MegaSection[] }
